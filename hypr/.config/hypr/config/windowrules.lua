...
hl.window_rule({ match = { class = "^(vesktop|discord)$" }, monitor = PRIMARY_MONITOR, workspace = "3" })
hl.window_rule({ match = { class = "^(Notion|notion.*)$" }, workspace = "3" })
hl.window_rule({ match = { class = "^(Spotify|spotify)$" }, workspace = "4" })
